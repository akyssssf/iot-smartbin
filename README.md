...
(`?v=20260923i`). **Setiap kali mengubah CSS, JS, atau file model, naikkan penandanya** di:
...
```bash
grep -rl "v=20260923i" index.html dashboard.html js/ | xargs sed -i '' 's/v=20260923i/v=20260923i/g'
```
